...
const socials = [
  ...
  {
    name: "Truth Social",
    url: "https://truthsocial.com/@PatrickByrne",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm-1 15H8V7h3c2.761 0 5 1.239 5 4v2c0 2.209-1.791 4-4 4zm1-3c1.105 0 2-.895 2-2v-2c0-1.105-.895-2-2-2h-1v6h1z" />
      </svg>
    ),
  },
];
